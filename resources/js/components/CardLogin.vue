    ...
    <div class="bg-gray-800">
        <div class="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
            <div class="sm:mx-auto sm:w-full sm:max-w-sm">
                <img class="mx-auto h-10 w-auto" src="https://cms-assets.unrealengine.com/AVzjeqAbLRKi3W5jq0CAvz/cmh5593q16fl807o62o6ern9j" alt="Fortnite" />
                <h2 class="mt-10 text-center text-2xl/9 font-bold tracking-tight text-white">Entre na sua conta</h2>
            </div>
            ...
            <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <p class="mt-10 text-center text-sm/6 text-gray-400">
                    Não tem conta?
                    {{ ' ' }}
                    <a href="/cadastrar" class="font-semibold text-indigo-400 hover:text-indigo-300">Cadastre-se</a>
                </p>
                <p class="mt-10 text-center text-sm/6">
                    <a href="/" class="font-semibold text-indigo-400 hover:text-indigo-300 text-center">< Voltar</a>
                </p>
            </div>
        </div>
    </div>
